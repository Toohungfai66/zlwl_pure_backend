        ...
        while True:
            ...
            for data in response["list"]:
                ...
                ls_dict = {
                    ...
                    "afn_fulfillable_quantity":int(data["afn_fulfillable_quantity"]),
                    "long_term_historical_days_of_supply":float(data["long_term_historical_days_of_supply"]),
                    "short_term_historical_days_of_supply":float(data["short_term_historical_days_of_supply"]),
                    "reserved_fc_transfers":int(data["reserved_fc_transfers"]),
