            ...
            if "MSKU" in _data["fields"] and "父ASIN" in _data["fields"] and "ASIN" in _data["fields"]:
                ...
                if pkl_name + ".pkl" not in os.listdir("C:\\Project\\Zlwl\\PMC\\static\\msku_fiels_model"):
                    update_data_list.append({
                        ...
                        "fields": {"周期(第一周)":0,"周期(第二周)":0,"周期(第三周)":0,"周期(第四周)":0,"周期(第五周)":0,"周期(第六周)":0,"周期(第七周)":0,"周期(第八周)":0,"周期(第九周)":0,"周期(第十周)":0,"周期(第十一周)":0}
                    }) 
                    continue
                if pkl_name in if_list:
                    ...
                    continue
                fields = {}
                for _data_1 in ["周期(第一周)","周期(第二周)","周期(第三周)","周期(第四周)","周期(第五周)","周期(第六周)","周期(第七周)","周期(第八周)","周期(第九周)","周期(第十周)","周期(第十一周)"]:
                    # 输入的日期范围字符串
